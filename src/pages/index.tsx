...
export default function Home({
  ...
  return (
    <div className="relative h-screen snap-y snap-mandatory overflow-scroll overflow-x-hidden bg-gray-900 text-white scrollbar-track-gray-400/20 scrollbar-thumb-secondary transition-transform duration-700 ease-in-out">
